...
def get_parameters():
    ...
    parser.add_argument('--model', type=str, default='wgan-div', choices=['wgan-div'])
    parser.add_argument('--adv_loss', type=str, default='wgan-div', choices=['wgan-div'])
    ...
    parser.add_argument('--g_lr', type=float, default=0.0002, help='default from paper')
    parser.add_argument('--d_lr', type=float, default=0.0002, help='default from paper')
